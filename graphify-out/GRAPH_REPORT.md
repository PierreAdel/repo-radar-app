...
Cohesion: 0.07
Nodes (21): App(), AppErrorBoundary, Props, State, store, ThemedApp(), getServerSnapshot(), getSnapshot() (+13 more)
...
Cohesion: 0.06
Nodes (33): AppDispatch, fetchMock, fetchMock, fetchMock, fetchMock, fetchMock, requestedUrl(), packages_core_src_api_githubapi_usegetrepositoryquery (+25 more)
...
Cohesion: 0.06
Nodes (34): EmptyState(), EmptyStateProps, meta, NoTrackedRepos, Story, TitleOnly, WithIconAndAction, ErrorFallback() (+26 more)

### Community 47 - "github-repo.js"
Cohesion: 0.29
Nodes (5): options, REPOS, options, QUERIES, ref_k6

### Community 48 - "TrackedReposSection.tsx"
Cohesion: 0.10
Nodes (13): fetchMock, TrackedRepoCard(), fetchMock, importFresh(), estimateRowSize(), GridListItem, gridListItemSx, plainGridTemplateColumns (+5 more)
...
Cohesion: 0.07
Nodes (37): useAppDispatch, useAppSelector, SearchResultsSection, StarsChartCard, RootState, visuallyHidden, MAX_SEARCH_QUERY_LENGTH, SearchBar() (+29 more)
...
- **Why does `react-router` connect `ref_testing_library_react` to `TrackedReposSection.tsx`, `web/package.json`, `core/src/index.ts`, `useTrackedRepoView.ts`?**
