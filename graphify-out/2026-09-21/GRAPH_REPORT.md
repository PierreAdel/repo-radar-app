...
Cohesion: 0.06
Nodes (36): Props, State, EmptyState(), EmptyStateProps, meta, NoTrackedRepos, Story, TitleOnly (+28 more)
...
Cohesion: 0.06
Nodes (44): App(), useAppDispatch, useAppSelector, SearchResultsSection, StarsChartCard, AppDispatch, store, ThemedApp() (+36 more)

### Community 49 - "TrackedReposSection.tsx"
Cohesion: 0.09
Nodes (14): fetchMock, TrackedRepoCard(), fetchMock, importFresh(), estimateRowSize(), GridListItem, gridListItemSx, plainGridTemplateColumns (+6 more)

### Community 52 - "core/src/index.ts"
Cohesion: 0.07
Nodes (32): RootState, fetchMock, fetchMock, selectTrackedRepoCacheEntries, fetchMock, fetchMock, githubApi, packages_core_src_api_githubapi_usegetrepositoryquery (+24 more)

## Knowledge Gaps
- **396 isolated node(s):** `semi`, `singleQuote`, `trailingComma`, `printWidth`, `ProxyResult` (+391 more)
...
- **Why does `react-router` connect `useTrackedRepoView.ts` to `TrackedReposSection.tsx`, `web/package.json`, `core/src/index.ts`?**
