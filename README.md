...
- **Not included**: no uptime/synthetic monitoring (e.g. UptimeRobot) is configured —
  noted rather than implied.
...
- **No automated dependency-audit tool or uptime monitor** is wired into CI yet.
